                ...
                <div className="grid gap-8">
                    <div className="col-span-full border-b pb-8">
                        <Link
                            ...
                            <LogoIcon className="h-5 w-fit" />
                            <span className='max-sm:hidden text-md'>Waves</span>
                        </Link>
                        <p className="text-muted-foreground mt-4 max-w-xs text-sm">Build and launch beautiful websites without the complexity.</p>
