        ...
        <section className="py-10 dark:bg-transparent">
            <div className="@container mx-auto max-w-5xl px-6">
                <div className="text-center">
                    <h2 className="text-balance text-4xl font-semibold lg:text-5xl">Craft Experiences Without Limits</h2>
                    <p className="mt-4">Design, generate, and launch beautiful Websites in minutes. <br/> A modern website builder powered by intelligent automation and total creative freedom.</p>
                </div>
